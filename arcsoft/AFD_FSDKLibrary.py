...
if platform.system() == u'Windows':
    if "32 bit" in sys.version:
        lib_file = os.path.join(WIN32_DIR, u"libarcsoft_fsdk_face_detection.dll")
    else:
        lib_file = os.path.join(WIN64_DIR, u"libarcsoft_fsdk_face_detection.dll")
else:
    lib_file = os.path.join(LINUX_X64_DIR, u"libarcsoft_fsdk_face_detection.so")
