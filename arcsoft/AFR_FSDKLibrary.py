...
from .utils.lib_path import LINUX_X64_DIR, WIN64_DIR, WIN32_DIR
...
if platform.system() == u'Windows':
    if "32 bit" in sys.version:
        lib_file = os.path.join(WIN32_DIR, u'libarcsoft_fsdk_face_recognition.dll')
    else:
        lib_file = os.path.join(WIN64_DIR, u'libarcsoft_fsdk_face_recognition.dll')
else:
    lib_file = os.path.join(LINUX_X64_DIR, u"libarcsoft_fsdk_face_recognition.so")

internalLibrary = CDLL(lib_file)
